...
A Windows desktop application built with **C# (.NET 9)** and **Windows Forms** for managing IT assets, employees, and assignments within an organization.
...
git clone https://github.com/Nosheen740/ITAssetManager.git
